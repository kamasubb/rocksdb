...
BENCHTOOLOBJECTS = $(BENCH_LIB_SOURCES:.cc=.o) $(LIB_SOURCES:.cc=.o) $(LIB_C_SOURCES:.c=.o) $(TESTUTIL) $(LIB_ASM_SOURCES:.S=.o)
...
librocksdb_env_basic_test.a: env/env_basic_test.o $(LIBOBJECTS) $(LIBASMOBJECTS) $(TESTHARNESS)
	$(AM_V_AR)rm -f $@
	$(AM_V_at)$(AR) $(ARFLAGS) $@ $^
...
memtablerep_bench: memtable/memtablerep_bench.o $(LIBOBJECTS) $(LIBASMOBJECTS) $(TESTUTIL)
	$(AM_LINK)
...
cache_test: cache/cache_test.o $(LIBOBJECTS) $(LIBASMOBJECTS) $(TESTHARNESS)
	$(AM_LINK)
...
histogram_test: monitoring/histogram_test.o $(LIBOBJECTS) $(LIBASMOBJECTS) $(TESTHARNESS)
	$(AM_LINK)
...
env_timed_test: utilities/env_timed_test.o $(LIBOBJECTS) $(LIBASMOBJECTS)  $(TESTHARNESS)
	$(AM_LINK)
...
env_basic_test: env/env_basic_test.o $(LIBOBJECTS) $(LIBASMOBJECTS) $(TESTHARNESS)
	$(AM_LINK)

env_test: env/env_test.o $(LIBOBJECTS) $(LIBASMOBJECTS) $(TESTHARNESS)
	$(AM_LINK)
...
inlineskiplist_test: memtable/inlineskiplist_test.o $(LIBOBJECTS) $(LIBASMOBJECTS) $(TESTHARNESS)
	$(AM_LINK)

skiplist_test: memtable/skiplist_test.o $(LIBOBJECTS) $(LIBASMOBJECTS) $(TESTHARNESS)
	$(AM_LINK)
...
options_test: options/options_test.o $(LIBOBJECTS) $(LIBASMOBJECTS) $(TESTHARNESS)
	$(AM_LINK)

options_settable_test: options/options_settable_test.o $(LIBOBJECTS) $(LIBASMOBJECTS) $(TESTHARNESS)
	$(AM_LINK)
...
mock_env_test : env/mock_env_test.o $(LIBOBJECTS) $(LIBASMOBJECTS) $(TESTHARNESS)
	$(AM_LINK)
...
auto_roll_logger_test: util/auto_roll_logger_test.o $(LIBOBJECTS) $(LIBASMOBJECTS) $(TESTHARNESS)
	$(AM_LINK)
...
iostats_context_test: monitoring/iostats_context_test.o $(LIBOBJECTS) $(LIBASMOBJECTS) $(TESTHARNESS)
	$(AM_V_CCLD)$(CXX) $^ $(EXEC_LDFLAGS) -o $@ $(LDFLAGS)
...
statistics_test: monitoring/statistics_test.o $(LIBOBJECTS) $(LIBASMOBJECTS) $(TESTHARNESS)
	$(AM_LINK)

lru_cache_test: cache/lru_cache_test.o $(LIBOBJECTS) $(LIBASMOBJECTS) $(TESTHARNESS)
	$(AM_LINK)
